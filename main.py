...
# Function to clear all data of the current Telegram client from the database
...
# Function to display the list of configured days and names
...
# Function to save the day and name into the database
